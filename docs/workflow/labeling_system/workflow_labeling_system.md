...
> 3. GitHub clone hatası alıyorsanız, Emirhan ile iletişime geçerek yetki talebinde bulunun.
...
*   **Eylem:** `datasets` kütüphanesi ile `push_to_hub` komutunu kullanarak senkronizasyonu sağla.
*   **Önemli Not:** Yükleme alanı şu an hazırlık aşamasındadır (Güncelleme: 26.07.2026 - 00:28). Eğer bu alan belirli bir süre sonra hala güncellenmemişse, lütfen **uludogan** ile iletişime geç.
